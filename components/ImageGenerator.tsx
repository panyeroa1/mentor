...
export const ImageGenerator: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col">
            <h2 className="text-2xl font-bold text-red-400 mb-4">AI Image Generator (Imagen 4.0)</h2>
            ...
            <div className="flex-grow bg-black rounded-lg p-4 flex items-center justify-center">
                {isLoading ? (
